    ...
    <div class="bg-gradient-to-r from-blue-900 via-blue-700 to-indigo-700 text-white p-8 rounded-2xl shadow-xl mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                <span class="bg-white/20 px-3 py-1 rounded-full text-sm font-medium">v1.1 · Path B</span>
            </div>
        </div>
    </div>
    """,
...
if selected_tab == "📏 Depth Profile":
    colored_header(
        label="Borehole Depth Profile",
        description="Enter the average metres drilled per borehole in each depth band",
        color_name="blue-70",
    )
...
# ─────────────────────────  TAB 2 — INSTRUMENTATION  ─────────────────────────
    ...
    colored_header(
        label="Instrumentation Setup",
        description="Specify how many boreholes will be instrumented and which extras are needed",
        color_name="blue-70",
    )
...
# ─────────────────────────  TAB 3 — IN-SITU TESTS  ─────────────────────────
    ...
    colored_header(
        label="In-Situ Testing Quantities",
        description="Enter the total number of each in-situ test required",
        color_name="blue-70",
    )
...
# ─────────────────────────  TAB 4 — LAB & CHEMICAL  ─────────────────────────
    ...
    colored_header(
        label="Laboratory & Chemical Testing",
        description="Use the sliders to auto-populate quantities, or adjust individually",
        color_name="blue-70",
    )
...
# ─────────────────────────  TAB 5 — RESULTS  ─────────────────────────
    ...
    # ---- HERO METRICS ----
    colored_header(label="Cost Summary",
                   description=f"Estimate for {project_name}",
                   color_name="blue-70")
...
st.markdown(
    ...
    <div class="text-center text-slate-500 text-sm mt-8 pb-4">
        ...
        <br/>GI Cost Calculator v1.1 · © 2026 Rohan Pokale
    </div>
    """,
    unsafe_allow_html=True,
)